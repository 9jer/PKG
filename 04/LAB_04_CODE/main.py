...
def draw():
    ...
    ax4.title.set_color('#FFFFFF')
    ax1.set_ylabel("y", labelpad=1, loc='bottom', color='#FFFFFF')  
    ax1.set_xlabel("x", labelpad=1, loc='left', color='#FFFFFF')
    ax2.set_ylabel("y", labelpad=1, loc='bottom', color='#FFFFFF')  
    ax2.set_xlabel("x", labelpad=1, loc='left', color='#FFFFFF')
    ax3.set_ylabel("y", labelpad=1, loc='bottom', color='#FFFFFF')  
    ax3.set_xlabel("x", labelpad=1, loc='left', color='#FFFFFF')
    ax4.set_ylabel("y", labelpad=1, loc='bottom', color='#FFFFFF')  
    ax4.set_xlabel("x", labelpad=1, loc='left', color='#FFFFFF')
    canvas.draw()
...
if __name__ == "__main__":
    ...
    fig = plt.figure(figsize=(5, 5), facecolor='#2E2E2E')
    frame1 = Frame(root, bg='#2E2E2E')
    ...
    btplot1 = Button(frame2, text='Draw', command=lambda: draw(), bg='#404040', fg='#FFFFFF')
